...
public class EntityTable {
    ...
    //需要自动填充时间的字段列表
    private List<String> needAutoGmtFields = new ArrayList<>();
    ...
    public List<String> getNeedAutoGmtFields() {
        return needAutoGmtFields;
    }

    public void addNeedAutoGmtField(String fieldName) {
        needAutoGmtFields.add(fieldName);
    }
}
